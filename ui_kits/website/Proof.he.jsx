...
const PROOF_HE = [
  ...
  },
  {
    ...
    body: 'הטמעתי משמעת של “בלי אפיון, אין קוד”, שערי איכות ב-CI, ובעלות על ריוויו &mdash; כדי להפחית עבודה כפולה ולמנוע זרימות שבורות.',
  ...
  },
  {
    ...
    body: 'בניתי תהליך חוזר ולקיחת חומר גולמי והפיכתו לתוכן מובנה ל-LinkedIn ו-Facebook &mdash; פחות התחלה מאפס, יותר עקביות בפרסום.',
